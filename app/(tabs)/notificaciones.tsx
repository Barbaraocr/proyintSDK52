  ...
  const loadScheduledNotifications = async () => {
    try {
      ...
      if (storedNotifications) {
        const parsedNotifications = JSON.parse(storedNotifications) as ScheduledNotification[];
        setScheduledNotifications(parsedNotifications);
        console.log('Notificaciones cargadas:', parsedNotifications); // Para verificar lo que se carga
      } else {
        console.log('No hay notificaciones programadas almacenadas.');
      }
    } catch (error) {
